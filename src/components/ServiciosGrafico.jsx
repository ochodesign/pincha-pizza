...
const ServiciosGrafico = () => (
  <section id="servicios"
    ...
    style={{
      backgroundImage: "url('/img/design-grafic/bg-design-grafico.webp')",
  ...
  <div className="absolute inset-0 bg-black/60" style={{zIndex:1, pointerEvents:'none'}} />
    <div className="relative z-10">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-white mb-10 text-center drop-shadow-lg">Servicios gráficos destacados</h2>
