...
const ProcesoGrafico = () => {
  ...
  return (
    <section
      className="py-16 bg-fixed relative"
      style={{
        backgroundImage: `linear-gradient(rgba(30,30,30,0.55), rgba(30,30,30,0.55)), url('/img/como-trabajamos/bg-como-trabajamos.webp')`,
