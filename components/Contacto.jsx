          ...
          >
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white hover:text-[#7a1f2a] transition-colors">
                  <Instagram size={24} />
                </a>
                <a href="#" className="text-white hover:text-[#7a1f2a] transition-colors">
                  <Facebook size={24} />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-white rounded-lg focus:ring-2 focus:ring-[#7a1f2a] focus:border-transparent bg-white text-[#7a1f2a] placeholder-[#7a1f2a]/60 focus:text-[#5a1620]"
              ...
              {enviado && (
                <div className="w-full text-center text-green-600 font-bold mb-4 animate-fadein">
                  ¡Mensaje enviado!
                </div>
              )}
